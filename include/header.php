...
<body>
	<nav class="navbar">  <!-- animated bounceInUp wow -->
			<div class="container">
				...
				<div id="mainnav" class="collapse menu_area navbar-collapse ">				
					<ul class=""> <!-- fadeInLeftBig wow -->
						...
						<li class="hvr-underline-from-right"><a href="#">Contact</a></li>
					</ul>
				</div>
